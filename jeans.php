...
<body>
    ...
    <section class="category-header">
        <div class="category-banner" style="background-image: url('assets/jeansbg.jpeg')">
            <h1>Jeans</h1>
            <p>Discover our premium selection of stylish jeans</p>
        </div>
    </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Load jeans products
            fetch('products.php?action=getByCategory&category_id=2') // Assuming 2 is the category ID for jeans
