...
<body>
    ...
    <section class="category-header">
        <div class="category-banner" style="background-image: url('assets/jeans-banner.jpg')">
            <h1>Jeans Collection</h1>
            <p>Find the perfect pair of jeans to elevate your wardrobe.</p>
        </div>
    </section>
    ...
    <script>
        ...
        window.onload = function () {
            <?php if ($userLoggedIn): ?>
                ...
                updateCartCount();
            <?php endif; ?>
            // Load products for jeans category
            loadProducts('jeans');
        };
