...
<body>
    ...
    <section class="category-header">
        <div class="category-banner" style="background-image: url('assets/tshirt-banner.jpg')">
            <h1>Shorts</h1>
            <p>Discover our premium selection of stylish shorts</p>
        </div>
    </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Load shorts products
            fetch('products.php?action=getByCategory&category_id=4') // Assuming 4 is the category ID for shorts
