...
<body>
    ...
    <section class="category-header">
        <div class="category-banner" style="background-image: url('assets/shorts-banner.jpg')">
            <h1>Shorts Collection</h1>
            <p>Discover our trendy and comfortable shorts for every occasion.</p>
        </div>
    </section>
    ...
    <script>
        ...
        window.onload = function () {
            <?php if ($userLoggedIn): ?>
                ...
                updateCartCount();
            <?php endif; ?>
            // Load products for shorts category
            loadProducts('shorts');
        };
